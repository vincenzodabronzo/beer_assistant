		...
		<div class="innertube"><b>Devices: <em>20%</em></b>
			<div class="device" id="show_devices">
				...
				<fieldset id="target_temp_group">
                    ...
                    <input type="text" name="target_temp_group" id="temp_upper_limit" maxlength="3" size="5" value="22.5"> (Example <b>22.5</b>)<br>
                    <label for="temp_lower_limit">Temp min &deg;C</label>
                    <input type="text" name="target_temp_group" id="temp_lower_limit" maxlength="3" size="5" value="20.0"> (Example <b>20.0</b>)<br>
